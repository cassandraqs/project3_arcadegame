...
var Engine = (function(global) {
    ...
    function main() {
         ...
         */
        var now = Date.now(),
            dt = (now - lastTime) / 1000.0;//eg:make 5000ms now to 5s, the first dt is different from the rest dt. the rest should be the time period between each time main() is called and should be stable.
